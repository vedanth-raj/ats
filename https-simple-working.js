...
httpsServer.listen(HTTPS_PORT, HOST, () => {
    console.log('🔒 HTTPS Server Successfully Running!');
    console.log('');
    ...
    console.log('');
    console.log('🚀 To Fix Chrome Certificate Warning:');
    console.log('   1. Go to: https://localhost:3443');
    console.log('   2. Click "Advanced"');
    console.log('   3. Click "Proceed to localhost (unsafe)"');
    console.log('   4. Or double-click chrome-fix.bat');
    console.log('');
