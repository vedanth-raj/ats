...
// Create a proper certificate using Node.js crypto
function createCertificate() {
    ...
    // Create a basic certificate manually
    const cert = [
        '-----BEGIN CERTIFICATE-----',
...
const { privateKey, cert } = createCertificate();

// HTTPS options with proper SSL configuration
const httpsOptions = {
    key: privateKey,
    cert: cert,
...
httpsServer.listen(HTTPS_PORT, HOST, () => {
    console.log('🔒 HTTPS Server with Fixed SSL Running!');
    console.log('');
    console.log('📍 Access URLs:');
    console.log(`   🌐 https://localhost:${HTTPS_PORT}`);
    console.log(`   🌐 https://127.0.0.1:${HTTPS_PORT}`);
    console.log(`   🌐 https://10.180.133.44:${HTTPS_PORT}`);
    console.log(`   🌐 https://192.168.56.1:${HTTPS_PORT}`);
    console.log('');
    console.log('🔧 SSL Configuration: TLS 1.2 with modern ciphers');
